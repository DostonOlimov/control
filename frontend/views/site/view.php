			...
			<div class="row">
				<div class="col-lg-12">
					<div style="background-color: #FFFFFF; padding: 20px; margin-bottom: 30px;">
						...
						<div style="margin-top: 10px;">
							<b><?= $model->getAttributeLabel('type_of_alert') ?>:</b> <?= (isset($model->type_of_alert)) ? $model->type_of_alert : ''; ?>
						</div>
						<div style="margin-top: 10px;">
							<b><?= $model->getAttributeLabel('type') ?>:</b> <?= (isset($model->type)) ? $model->type : ''; ?>
						</div>
						<div style="margin-top: 10px;">
						...
						<div style="margin-top: 10px;">
							<b><?= $model->getAttributeLabel('risk_type') ?>:</b> <?= (isset($model->risk_type)) ? $model->risk_type : ''; ?>
						</div>
						<div style="margin-top: 10px;">
